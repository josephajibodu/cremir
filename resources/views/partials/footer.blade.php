            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <ul class="footer-address-list ftr-details">
                        <li>
                            ...
                            <p>Email <span> <a href="mailto:info@cremir.org">info@cremir.org</a></span></p>
                        </li>
                        <li>
                            <span><i class="fas fa-phone-alt"></i></span>
                            <p>Phone <span> <a href="tel:+2348167297386">+234 816 7297 386</a></span></p>
                        </li>
                        <li>
                            <span><i class="fas fa-map-marker-alt"></i></span>
                            <p>Address <span> Ola Asherifa Estate, Ile-Ife, Nigeria</span></p>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-2 col-sm-6">
                    ...
                    <ul class="footer-address-list link-hover">
                        <li><a href="{{ route('static', 'get-quote') }}">Contact Us</a></li>
                        <!-- <li><a href="{{ route('static', 'customer-faq') }}">Customer's FAQ</a></li>
                        <li><a href="{{ route('static', 'privacy-policy') }}">Privacy Policy</a></li>
                        <li><a href="{{ route('static', 'terms-and-condition') }}">Terms and Conditions</a></li> -->
                    </ul>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="footer-">
                            <p>Copyright &copy; 2020 Cremir. All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
