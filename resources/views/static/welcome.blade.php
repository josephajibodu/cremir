...
{{--                            </p>--}}
                            ...
                            <a href="{{ route('static', ['get-quote']) }}" class="btn-main bg-btn lnk wow fadeInUp" data-wow-delay=".6s">Talk to us now <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                        </div>
                    </div>
                    <div class="col-lg-6 v-center">
                ...
                <div class="col-lg-12">
                    <div class="opl">
                        <ul class="d-flex justify-content-center">
                            ...
                            <li class=" wow fadeIn" data-wow-delay=".4s">
                                <div class="clients-logo"><img src="images/client/farmtify.png" alt="text" class="img-fluid"/></div>
                            </li>
                        </ul>
                    </div>
                </div>
