                ...
                <div class="row">
                    <div class="col-lg-6 v-center">
                        <div class="header-heading">
                            ...
                            <a href="{{ route('static', 'get-quote') }}" class="btn-main bg-btn3 lnk wow fadeInUp" data-wow-delay=".6s">GET STARTED<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                        </div>
                    </div>
                    <div class="col-lg-6 v-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="common-heading text-l">
                        ...
                        <h2>About Agency</h2>
                        <p>We are a team of creatives focusing majorly on loosing your business knots. We help brand your business digitally with our services ranging from Website Development to Digital Marketing to Mobile app development to logo and graphic designs. We help your business/ brand stand out amongst your competitors thereby making you visible to your potential client.</p>
                        <p class="quote">I make sure that every client that comes to CREMIR with their business or brand challenges get wowed by the time a solution is provided.</p>
                        <div class="user- mt30">
                            <div class="media">
                                <div class="user-image bdr-radius"><img src="images/user-thumb/ceo.png" alt="girl" class="img-fluid" /></div>
        ...
        <div class="container">
            ...
            <div class="row upset link-hover shape-num justify-content-center">
                ...
                <div class="col-lg-3 col-sm-6 mt30 shape-loc wow fadeInUp" data-wow-delay="0.6s">
                    <div class="s-block" data-tilt data-tilt-max="5" data-tilt-speed="1000">
                        ...
                        <p>Native or Hybrid, our apps are compliant with the latest technological standards to ensure the best performance.</p>
                    </div>
                </div>
            ...
            <div class="-cta-btn mt70">
                <div class="free-cta-title v-center wow zoomInDown" data-wow-delay=".9s">
                    ...
                    <a href="{{ route('static', 'get-quote') }}" class="btn-main bg-btn2 lnk">Hire Now<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
                    ...
                    <div class="opl">
                        <ul class="d-flex justify-content-center">
                            <li class=" wow fadeIn" data-wow-delay=".2s">
                                <div class="clients-logo"><img src="images/client/konnect.png" alt="text" class="img-fluid"/></div>
                            </li>
                            <li class=" wow fadeIn" data-wow-delay=".4s">
                                <div class="clients-logo"><img src="images/client/phinafoods.png" alt="text" class="img-fluid"/></div>
                            </li>
                            <li class=" wow fadeIn" data-wow-delay=".4s">
                                <div class="clients-logo"><img src="images/client/tradegoal.png" alt="text" class="img-fluid"/></div>
                            </li>

                            <li class=" wow fadeIn" data-wow-delay=".4s">
                                <div class="clients-logo"><img src="images/client/onlineHealthHub.png" alt="text" class="img-fluid"/></div>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="-cta-btn mt70">
                <div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1.2s">
                    ...
                    <a href="{{ route('static', 'get-quote') }}" class="btn-main bg-btn2 lnk">Let's Work Together<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-card-a pl25">
                        <div class="testimonial-card">
                            ...
                            <div class="client-thumbs mt30">
                                <div class="media v-center">
                                    <div class="user-image bdr-radius"><img src="images/user-thumb/woman.png" alt="Lady" class="img-fluid" /></div>
                                    <div class="media-body user-info v-center">
                                        <h5>Esther Alade</h5>
                        ...
                        <div class="testimonial-card">
                            ...
                            <div class="client-thumbs mt30">
                                <div class="media v-center">
                                    <div class="user-image bdr-radius"><img src="images/user-thumb/man.png" alt="Man" class="img-fluid" /></div>
                        ...
                        <div class="testimonial-card">
                            <div class="t-text">
                                <p>Wow!! Just checked the features you added. Perfect!! I like the way you arranged the admin dashboard as well. Thank you so much.</p>
                            </div>
                            <div class="client-thumbs mt30">
                                <div class="media v-center">
                                    <div class="user-image bdr-radius"><img src="images/user-thumb/man.png" alt="Man" class="img-fluid" /></div>
                    ...
                    <div class="form-block">
                        <form action="{{ route('contact') }}" method="post" name="feedback-form">
                            ...
                            <div class="fieldsets row">
                                <div class="col-md-6">
                                    <input type="text" class="@error('name') is-invalid @enderror" placeholder="Full Name" value="{{ old('name') }}" name="name">
                                    @error('name')
                                ...
                                <div class="col-md-6">
                                    <input type="email"  class="@error('email') is-invalid @enderror" placeholder="Email Address" value="{{ old('email') }}" name="email">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="fieldsets row">
                                <div class="col-md-6">
                                    <input type="text"  class="@error('phone') is-invalid @enderror" placeholder="Contact Number" value="{{ old('phone') }}" name="phone">
                                    @error('phone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6">
                                    <input type="text"  class="@error('subject') is-invalid @enderror" placeholder="Subject" value="{{ old('subject') }}" name="subject">
                                    @error('subject')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="fieldsets">
                                <textarea placeholder="Message"  class="@error('email') is-invalid @enderror" name="message"></textarea>
                                @error('message')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
